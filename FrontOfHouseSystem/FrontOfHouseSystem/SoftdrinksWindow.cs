...
namespace FrontOfHouseSystem
{
    public partial class SoftdrinksWindow : Form
    {
        ...
        public SoftdrinksWindow(int UserID, string FirstName, string LastName, ListBox.ObjectCollection orderItems, string userName, string amount)
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            FOHDashboard mainMenu = new FOHDashboard(userID, firstName, lastName, OrderList.Items, Usernamelbl.Text, AmountLabel.Text);
            mainMenu.Show();
        }
