...
namespace ManagementApplication {
    ...
    public partial class UserData : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(int UserTypeID, string Title, string FirstName, string SecondName, string ContactNumber, string EmailAddress, int Pin) {
...
namespace ManagementApplication.UserDataTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ((@IsNull_UserTypeID = 1 AND [UserTypeID] IS NULL) OR ([UserTypeID] = @Original_UserTypeID)) AND ([Title] = @Original_Title) AND ([FirstName] = @Original_FirstName) AND ([SecondName] = @Original_SecondName) AND ([ContactNumber] = @Original_ContactNumber) AND ([EmailAddress] = @Original_EmailAddress) AND ([Pin] = @Original_Pin))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([UserTypeID], [Title], [FirstName], [SecondName], [ContactNumber], [EmailAddress], [Pin]) VALUES (@UserTypeID, @Title, @FirstName, @SecondName, @ContactNumber, @EmailAddress, @Pin);
SELECT UserID, UserTypeID, Title, FirstName, SecondName, ContactNumber, EmailAddress, Pin FROM Users WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserTypeID] = @UserTypeID, [Title] = @Title, [FirstName] = @FirstName, [SecondName] = @SecondName, [ContactNumber] = @ContactNumber, [EmailAddress] = @EmailAddress, [Pin] = @Pin WHERE (([UserID] = @Original_UserID) AND ((@IsNull_UserTypeID = 1 AND [UserTypeID] IS NULL) OR ([UserTypeID] = @Original_UserTypeID)) AND ([Title] = @Original_Title) AND ([FirstName] = @Original_FirstName) AND ([SecondName] = @Original_SecondName) AND ([ContactNumber] = @Original_ContactNumber) AND ([EmailAddress] = @Original_EmailAddress) AND ([Pin] = @Original_Pin));
SELECT UserID, UserTypeID, Title, FirstName, SecondName, ContactNumber, EmailAddress, Pin FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, UserTypeID, Title, FirstName, SecondName, ContactNumber, EmailAddr" +
                "ess, Pin FROM dbo.Users";
        ...
        public virtual int Delete(int Original_UserID, global::System.Nullable<int> Original_UserTypeID, string Original_Title, string Original_FirstName, string Original_SecondName, string Original_ContactNumber, string Original_EmailAddress, int Original_Pin) {
        ...
        public virtual int Insert(global::System.Nullable<int> UserTypeID, string Title, string FirstName, string SecondName, string ContactNumber, string EmailAddress, int Pin) {
            if ((UserTypeID.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[0].Value = ((int)(UserTypeID.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    int UserID) {
            if ((UserTypeID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(UserTypeID.Value));
            }
            else {
            ...
            if ((Original_UserTypeID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_UserTypeID.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_Pin));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> UserTypeID, string Title, string FirstName, string SecondName, string ContactNumber, string EmailAddress, int Pin, int Original_UserID, global::System.Nullable<int> Original_UserTypeID, string Original_Title, string Original_FirstName, string Original_SecondName, string Original_ContactNumber, string Original_EmailAddress, int Original_Pin) {
            return this.Update(UserTypeID, Title, FirstName, SecondName, ContactNumber, EmailAddress, Pin, Original_UserID, Original_UserTypeID, Original_Title, Original_FirstName, Original_SecondName, Original_ContactNumber, Original_EmailAddress, Original_Pin, Original_UserID);
        }
    }
